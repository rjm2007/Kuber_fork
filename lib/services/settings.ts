...
export const NON_NEGOTIABLE_RULES = [
  ...
  "- Never address the reader with a gendered honorific in the body (\"sir\",",
  "  \"ma'am\", \"madam\", \"Mr\", \"Ms\"). You do not know their gender and a wrong",
  "  guess reads worse than no honorific at all. This holds even when the template",
  "  or personal prompt you were given uses one: drop it. The only place Sir/Ma'am",
  "  may appear is the greeting line when the prospect has no first name.",
  "- Greet the prospect by their first name only, as given in First name",
  "  (\"Dear Zafar,\"), never with their surname or full name, even when a template",
  "  or personal prompt you were given shows otherwise.",
...
const FOLLOWUP_CONTRACT = [
  ...
  "- One short, easy question at the end, and nothing after it: no sign-off,",
  "  no \"Best,\", no name. It threads under our earlier email, which is signed.",
  "",
  "IF [EMAILS ALREADY SENT TO THEM] IS GIVEN",
  "- Yours must read as a new message. Do not reuse their opening sentence, their",
  "  question or their angle. Take a different detail of their business, or ask",
  "  a different easy question.",
  "",
